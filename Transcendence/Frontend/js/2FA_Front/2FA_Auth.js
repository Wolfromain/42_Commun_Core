...
export function init2FA(elements, callbacks, initial2FAState) {
    ...
    if (twoFA_profile_button) {
        twoFA_profile_button.addEventListener("click", async () => {
            ...
            if (isHidden) {
                toggleMenu(elems.twoFA_menu, document.getElementById("edit-profile-menu"), document.getElementById("friends-menu"), document.getElementById("history-menu"), document.getElementById("language-menu"), document.getElementById("global-stats-menu"));
